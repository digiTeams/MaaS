...
class Feasible_Condition:
    def __init__(self, information, price_scaling):
    ...
    def share_price(self, rider_time, type, rule):
        ...
        if type == 'one':
            if distance < 10:
                price = detour_dis * 1.01 + (distance * 1.01) * self.price_scaling
            elif 10 <= distance < 30:
                price = detour_dis * 1.01 + (10 * 1.01 + (distance - 10) * 1.12) * self.price_scaling
            elif 30 <= distance < 50:
                price = detour_dis * 1.01 + (10 * 1.01 + 20 * 1.12 + (distance - 30) * 0.57) * self.price_scaling
            elif 50 <= distance < 100:
                price = detour_dis * 1.01 + (10 * 1.01 + 20 * 1.12 + 20 * 0.57 + (distance - 50) * 0.92) * self.price_scaling
            else:
                price = detour_dis * 1.01 + (10 * 1.01 + 20 * 1.12 + 20 * 0.57 + 50 * 0.92 + (distance - 100) * 0.4) * self.price_scaling
        else:
            if distance < 10:
                price = detour_dis * 0.81 + (distance * 0.81) * self.price_scaling
            elif 10 <= distance < 30:
                price = detour_dis * 0.81 + (10 * 0.81 + (distance - 10) * 0.90) * self.price_scaling
            elif 30 <= distance < 50:
                price = detour_dis * 0.81 + (10 * 0.81 + 20 * 0.90 + (distance - 30) * 0.57) * self.price_scaling
            elif 50 <= distance < 100:
                price = detour_dis * 0.81 + (10 * 0.81 + 20 * 0.90 + 20 * 0.57 + (distance - 50) * 0.92) * self.price_scaling
            else:
                price = detour_dis * 0.81 + (10 * 0.81 + 20 * 0.90 + 20 * 0.57 + 50 * 0.92 + (distance - 100) * 0.4) * self.price_scaling
        # 对该服务乘客收取的服务费用
