...
# 定义横坐标距离范围
distances = np.linspace(-5, 120, 500)
...
# 设置网格线
plt.xticks([0, 10, 30, 50, 100])
critical_points = []
for x in [0, 10, 30, 50, 100]:
...
plt.axhline(y=3.24, color='grey', linestyle='-', linewidth=0.5, alpha=0.4)
...
plt.arrow(35,63,10, -15, head_width=1.5, head_length=1.5, fc='darkgrey', color='darkgrey', alpha=0.9)   # 添加箭头
text_share = ('    0 - 10 km: 0.81 CNY/km \n  10 - 30 km: 0.90 CNY/km \n  30 - 50 km: 0.57 CNY/km \n'
              '  50-100 km: 0.92 CNY/km \n  100 -    km: 0.40 CNY/km')
plt.text(73, 24, text_share, fontsize=8, ha='left', color='black', alpha=0.7)
plt.arrow(73,34, -15, 10, head_width=1.5, head_length=1.5, fc='darkgrey', color='darkgrey', alpha=0.9)   # 添加箭头

text_detour = ('3.24')
plt.text(-21, -1, text_detour, fontsize=8, ha='left', color='black')
